...
An interactive stock portfolio risk & return dashboard, styled after the Bloomberg Terminal — black background, amber accents, monospace type, multi-panel "workstation" layout. Built with Python, pandas, and Plotly. https://eshaaalali.github.io/portfolio-analytics-terminal/
